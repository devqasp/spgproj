package com.example.dev.qa.spgproj.config;
...
public class SwaggerConfiguration {
	...
	private final String CONTROLLERS_PACKAGE = "com.example.dev.qa.spgproj.resources";
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.contact(new Contact("NPML - Niky Lima", "https://wherever.com.br", "npml@email.com.br"))
				.build();
	}
